...
export async function seedDatabase(dbPath?: string): Promise<{ count: number; source: string }> {
  ...
  // 7. Always add hotel lobbies (free), cafés, restaurants, fast food chains, and restaurant chains (purchase_required)
  const embedded = [
